...
public class Arkanoid2 extends JFrame implements KeyListener {
	...
	class ScoreBoard {
		...
		void increaseScore(Brick mBrick) {
			Color color=mBrick.color;
	...
	void testCollision(Brick mBrick, Ball mBall, ScoreBoard scoreboard) {
		...
		scoreboard.increaseScore(mBrick);
